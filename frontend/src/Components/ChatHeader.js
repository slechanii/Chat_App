        ...
        return (
            <Grid.Row columns="16" className="chat-header">
                {this.props.isUserChat === false ?
                    <React.Fragment>
                        ...
                        <Grid.Column width="8" className="center-vertical">
                            <div id="chat-header-menu-container">
                                ...
                                <ChannelMenu isUserChat={this.props.isUserChat} channelMembers={this.props.channelMembers} changeState={this.props.changeState} refreshMessages={this.props.refreshMessages} channels={this.props.channels} refreshChannels={this.props.refreshChannels} channelId={this.props.channelId}></ChannelMenu>
                            </div>
                        </Grid.Column>
                    </React.Fragment>
                    :
                    ...
                    <Grid.Column width="8" className="center-vertical">
                        <Button id="channel-title-user-chat" className="unstyled text-btn">
                            #{this.props.channelName}
                        </Button>
                    </Grid.Column>
                    <Grid.Column width="8" className="center-vertical">
